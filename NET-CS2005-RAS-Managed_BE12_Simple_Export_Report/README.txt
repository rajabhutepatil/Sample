...
SAMPLE - NET-CS2005-RAS-Managed_BE12_Simple_Export_Report.zip
...
DESCRIPTION
	...
	This is a sample application that shows how to export a report using Business Objects 
	Enterprise XI 3.1.
...
INSTALLATION
	...
	1. Copy the "NET-CS2005-RAS-Managed_BE12_Simple_Export_Report" folder to the "C:\inetpub\wwwroot" directory.
	2. Configure the "NET-CS2005-RAS-Managed_BE12_Simple_Export_Report" directory as an application in Internet
	Information Services.
		...
		c)  Right-click on the "NET-CS2005-RAS-Managed_BE12_Simple_Export_Report" node and select "Properties".
	...
	4. Browse through Local IIS and select NET-CS2005-RAS-Managed_BE12_Simple_Export_Report and click Open.
