<%@ Page language="c#" Codebehind="default.aspx.cs" AutoEventWireup="false" Inherits="rcapi_cs_add_parameter._default" %>
	...
	<body>
		<div id="mainContainer">
			<div id="sampleDescriptionDiv">
				<h1 id="sampleTitle">Add Parameter to Report Sample</h1>
				<p id="sampleDescription">
					This sample demonstrates how to add a parameter to an existing report using 
					managed RAS with Business Objects Enterprise XI release 2.</p>
			</div>
		...
		****************************************************** -->
			<form id="sampleForm" runat="server">
				<table class="infoTbl">
					...
					<tr>
						<td></td>
						<td><asp:button id="submitBtn" runat="server" Text="Submit" CssClass="btn"></asp:button></td>
					</tr>
				</table>
			</form>
			<div class="infoDiv">
