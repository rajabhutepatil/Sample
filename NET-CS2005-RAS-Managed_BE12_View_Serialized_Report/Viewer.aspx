...
<body>
    ...
    <div>
        <asp:Button ID="btnClose" runat="server" Text="Close" OnClick="btnClose_Click" /><br />
        <CR:CrystalReportViewer ID="boCrystalReportViewer" runat="server" AutoDataBind="true" />
